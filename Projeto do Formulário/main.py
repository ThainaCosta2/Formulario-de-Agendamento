...
frame_cima = Frame(janela, width=310, height=50, background=cor2, relief='flat')
...
##### Label Cima #####
app_nome = Label(frame_cima, text='Formulário de Agendamento', anchor=NW, font=('Ivy 13 bold'), background=cor2, fg=cor1, relief='flat')
